...
const core = {
	...
	getPipelines(type) {
		...
		return pipelines.filter(pipeline => {
			...
			if (core.args.black && hasOneOf(core.args.black, names)) {
				return false;
			}

			if (core.args.white && !hasOneOf(core.args.white, names)) {
				return false;
			}

			if (pipeline.disabled) {
				if (core.args.gray) {
					if (!hasOneOf(core.args.gray, names)) {
						return false;
					}
				} else {
					return false;
